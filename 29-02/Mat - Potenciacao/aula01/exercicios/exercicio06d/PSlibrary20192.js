...
function grid2(x, y, Nx, Ny, passo, stroke,color){
...
function eixoXpos(x, y, tamanho){
	var x; y;	
	var dx = 25;
	var L = tamanho*dx;
	vector(x, y, L + dx, 0, 2.5, darkcolor);
	graduatedScale(x, y + 10, L, dx, 5, 0, 2.2, darkcolor);	
	numberScalePosX(x - 4, y + dx, tamanho, 1, dx, darkcolor);	
}

//Eixo x com escala numérica, iniciando no 0
function eixoYpos(x, y, tamanho){
	var x; y;	
	var dx = 25;
	var L = tamanho*dx;
	vector(x, y, L + dx, -90, 2.5, darkcolor);
	graduatedScale(x - 5, y, L, dx, 5, -90, 2.2, darkcolor);	
	numberScalePosY(x - 25, y + 3, tamanho, 1, -dx, darkcolor);	
}
...
function eixoX5(x, y){
	...
	var px = x - 142.5;
	var L = 285;
	vector(px + 5, y, L, 0, 2.5, darkcolor);
	graduatedScale(px + 17.5, y + 10, L - 25, 25, 5, 0, 2.2, darkcolor);
	numberScaleX2(x, y + 25, 5, 1, 25, darkcolor);	
}
