var xE = 90; 		//POSIÇÃO X DA PRIMEIRA COLUNA
var xD = xE + 245;  //POSIÇÃO X DA SEGUNDA COLUNA
var y0 = 55;        //POSIÇÃO INICIAL EM Y
var dy = 98;        //ESPAÇAMENTO VERTICAL DOS PONTOS (NÃO PODE SER MENOR QUE R)
...
var corCirculoD = 'rgba(1, 163, 164,0.01)'; //COR CÍRCULOS DO LADO DIREITO
// - ********************** -
var xp = [xE, xE, xE, xE];
